...
def create(origin_file_path='train_3k.txt', max_summa_len=4):
    my_rouge = Myrouge()
...
if __name__ == "__main__":
    ...
    # import pandas as pd
    # lens_data = []
    # with open("/media/nile/study/softwares/baidu_netdisk/download/bytecup2018/summ_t_83566.txt", 'r', encoding='utf-8') as f:

...
class Params:
    ...
    # Data
    embed_file: Optional[str] = '/home/nile/Downloads/glove.6B.100d.txt'  # use pre-trained embeddings
    data_path: str = '/media/nile/study/repositorys/autosumma/train.txt'
    val_data_path: Optional[str] = '/media/nile/study/repositorys/autosumma/val.txt'
    ...
    test_data_path: str = '/media/nile/study/repositorys/autosumma/test.txt'

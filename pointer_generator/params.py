...
class Params:
    ...
    hidden_size: int = 200  # of the encoder; default decoder size is doubled if encoder is bidi
    dec_hidden_size: Optional[int] = 150  # if set, a matrix will transform enc state into dec state
    embed_size: int = 100
    enc_bidi: bool = True
    ...
    lr: float = 1e-3  # learning rate 最重要
    adagrad_accumulator: float = 0.1
    lr_decay_step: int = 1  # decay lr every how many epochs?
    lr_decay: Optional[float] = 0.9 # None decay lr by multiplying this factor
    batch_size: int = 8
    n_batches: int = 10  # how many batches per epoch
    ...
    # Data
    embed_file: Optional[str] = '../data/english/sum2tit/glove.6B.100d.txt'  # use pre-trained embeddings
    data_path: str = '../data/english/sum2tit/train.txt'
    val_data_path: Optional[str] = '../data/english/sum2tit/val.txt'
    ...
    test_data_path: str = '../data/english/sum2tit/test.txt'

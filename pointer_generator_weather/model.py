...
from pointer_generator_weather.utils import Vocab, Hypothesis
from typing import Union, List

# 如果要迁移到云服务器上，这里直接改成cpu
...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, vocab: Vocab, params: Params, max_dec_steps=None, use_gpu=True):
        """
